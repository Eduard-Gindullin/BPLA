...
# Кнопка телеметрии
csv_telem_button = tk.Button(window, text="Запись телеметрии", width=20, bg="blue", fg="white", relief="solid", command=start_telemetry_recording).grid(row=12, column=0, columnspan=2, padx=20, pady=5)
